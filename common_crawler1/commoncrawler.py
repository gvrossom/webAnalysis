...
# force the use of UTF-8 character encoding to keep the csv module happy when we are 
# outputting results to our spreadsheet.
import sys
reload(sys)
sys.setdefaultencoding('utf8')

# parse the command line arguments and store the result in domain variables
...
# Check datasets available http://commoncrawl.org/the-data/get-started/
# index_list = ["2014-52","2015-06","2015-11","2015-14","2015-18","2015-22","2015-27"]
index_list = ["2016-36","2016-40"]
